...
def test_c_hosted_rustic_interpreter_computes_balance_patrol_threshold_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_patrol([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source], text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, timeout=2
    )

    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2783\n"


def test_c_hosted_rustic_interpreter_computes_balance_post_threshold_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_post([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2792\n"


def test_c_hosted_rustic_interpreter_computes_balance_audit_transition_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_audit([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2802\n"


def test_c_hosted_rustic_interpreter_computes_balance_proof_threshold_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_proof([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2811\n"


def test_c_hosted_rustic_interpreter_computes_balance_claim_threshold_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_claim([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2820\n"


def test_c_hosted_rustic_interpreter_computes_balance_assert_transition_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_assert([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2830\n"


def test_c_hosted_rustic_interpreter_computes_balance_verify_threshold_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_verify([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2839\n"


def test_c_hosted_rustic_interpreter_computes_balance_verify_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([1, 8, 9, 3, 0, 1], 3, 6)": -2304,
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_assert_outlier_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "outlier_run_signal_density_band_span_gap_delta_balance_assert([1, 8, 9, 3, 0, 1], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2296\n"


def test_c_hosted_rustic_interpreter_computes_balance_assert_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_composes_balance_assert_with_clamp(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_assert(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_assert(clamp([9, 1, 5, 3], 2, 6), 3, 5)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -3141\n"


def test_c_hosted_rustic_interpreter_composes_balance_verify_with_clamp(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_verify(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_verify(clamp([9, 1, 5, 3], 2, 6), 3, 5)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -3153\n"


def test_c_hosted_rustic_interpreter_computes_balance_assure_shortest_run_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_assure([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2846\n"


def test_c_hosted_rustic_interpreter_computes_balance_check_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_check([1, 8, 9, 3, 0, 1], 3, 6)": -2318,
        "threshold_run_signal_density_band_span_gap_delta_balance_check([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_check([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_check([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_check([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_check([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_check([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_check_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_check(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_check([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_check([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_check([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_check(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_check([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_check([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_check([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_composes_balance_check_with_clamp(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_check(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_check(clamp([9, 1, 5, 3], 2, 6), 3, 5)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -3173\n"


def test_c_hosted_rustic_interpreter_releases_balance_check_temporaries(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_check([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -185575,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_check([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -150670,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_check_matching_run_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_check([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2855\n"


def test_c_hosted_rustic_interpreter_computes_balance_assure_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([1, 8, 9, 3, 0, 1], 3, 6)": -2311,
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_assure_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_assure(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_assure([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_assure(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_assure([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_composes_balance_assure_with_clamp(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "threshold_run_signal_density_band_span_gap_delta_balance_assure(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_assure(clamp([9, 1, 5, 3], 2, 6), 3, 5)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -3165\n"


def test_c_hosted_rustic_interpreter_releases_balance_assure_temporaries(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_assure([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -184990,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_assure([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -150215,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_claim_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([1, 8, 9, 3, 0, 1], 3, 6)": -2289,
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_proof_outlier_pressure(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    source = "outlier_run_signal_density_band_span_gap_delta_balance_proof([1, 8, 9, 3, 0, 1], 3, 6)"
    result = subprocess.run(
        [str(binary), source],
        text=True,
        stdout=subprocess.PIPE,
    ...
    assert result.returncode == 0, result.stderr
    assert result.stdout == f"{source} => -2282\n"


def test_c_hosted_rustic_interpreter_computes_balance_proof_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_audit_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([1, 8, 9, 3, 0, 1], 3, 6)": -2274,
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_post_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_post([1, 8, 9, 3, 0, 1], 3, 6)": -2267,
        "threshold_run_signal_density_band_span_gap_delta_balance_post([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_post([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_post([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_post([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_post([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_post([], 3, 6)": 0,
    }
...
def test_c_hosted_rustic_interpreter_computes_balance_patrol_outlier_and_edge_cases(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([1, 8, 9, 3, 0, 1], 3, 6)": -2260,
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([], 3, 6)": 0,
    }
    for source, expected in expectations.items():
        result = subprocess.run(
            [str(binary), source], text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, timeout=2
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_patrol_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_patrol([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_patrol([1], 0)": "wrong argument count",
    }
    for source, expected in expectations.items():
        result = subprocess.run(
            [str(binary), source], text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, timeout=2
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_post_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_post(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_post([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_post([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_post([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_post(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_post([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_post([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_post([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_proof_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_proof(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_proof([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_proof(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_proof([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_claim_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_claim(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_claim([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_claim(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_claim([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_assert_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_assert(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_assert([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_assert(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_assert([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_verify_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_verify(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_verify([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_verify(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_verify([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_audit_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_audit(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_audit([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_audit(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_audit([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_computes_array_threshold_validation_helpers(tmp_path):
    ...
    expectations = {
        ...
        "threshold_run_signal_density_band_span_gap_delta_balance_note([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1804,
        "threshold_run_signal_density_band_span_gap_delta_balance_note([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_note([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_note([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1811,
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1821,
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1830,
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_song([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1837,
        "threshold_run_signal_density_band_span_gap_delta_balance_song([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_song([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_song([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1847,
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1856,
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1863,
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1873,
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1882,
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1889,
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1898,
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1908,
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1917,
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1924,
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_return([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1933,
        "threshold_run_signal_density_band_span_gap_delta_balance_return([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_return([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_return([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1943,
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1952,
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1959,
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1969,
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1978,
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1985,
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1994,
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2004,
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2013,
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2020,
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2029,
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2039,
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2048,
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2055,
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2064,
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2074,
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2083,
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2090,
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2099,
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2109,
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2118,
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2125,
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2134,
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2144,
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2153,
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2160,
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2169,
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2179,
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2188,
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2195,
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_power([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2204,
        "threshold_run_signal_density_band_span_gap_delta_balance_power([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_power([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_power([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_force([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2214,
        "threshold_run_signal_density_band_span_gap_delta_balance_force([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_force([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_force([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2223,
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2230,
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2239,
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_work([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2249,
        "threshold_run_signal_density_band_span_gap_delta_balance_work([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_work([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_work([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2258,
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2265,
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2274,
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2284,
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2293,
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_char([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2300,
        "threshold_run_signal_density_band_span_gap_delta_balance_char([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_char([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_char([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2309,
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2319,
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2328,
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2335,
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2344,
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2354,
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2363,
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2370,
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2379,
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2389,
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2398,
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2405,
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2414,
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2424,
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_air([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2433,
        "threshold_run_signal_density_band_span_gap_delta_balance_air([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_air([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_air([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2440,
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2449,
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2459,
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2468,
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2475,
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2484,
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2494,
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2503,
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2510,
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2519,
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2529,
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2538,
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2545,
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2554,
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2564,
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2573,
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2580,
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2589,
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2599,
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2608,
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2615,
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2624,
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2634,
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2643,
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2650,
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2659,
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2669,
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2678,
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2685,
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2694,
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_key([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2704,
        "threshold_run_signal_density_band_span_gap_delta_balance_key([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_key([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_key([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_code([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2713,
        "threshold_run_signal_density_band_span_gap_delta_balance_code([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_code([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_code([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2720,
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_token([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2729,
        "threshold_run_signal_density_band_span_gap_delta_balance_token([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_token([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_token([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2739,
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2748,
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2755,
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2764,
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2774,
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2783,
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2783,
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2790,
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2800,
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([1, 8, 9, 3, 0, 1], 3, 6)": -2274,
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([], 3, 6)": 0,
        ...
        "outlier_run_signal_density_band_span_gap_delta_balance_note([1, 8, 9, 3, 0, 1], 3, 6)": -1447,
        "outlier_run_signal_density_band_span_gap_delta_balance_note([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_note([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_note([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([1, 8, 9, 3, 0, 1], 3, 6)": -1454,
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([1, 8, 9, 3, 0, 1], 3, 6)": -1461,
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([1, 8, 9, 3, 0, 1], 3, 6)": -1469,
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_song([1, 8, 9, 3, 0, 1], 3, 6)": -1476,
        "outlier_run_signal_density_band_span_gap_delta_balance_song([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_song([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_song([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([1, 8, 9, 3, 0, 1], 3, 6)": -1483,
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([1, 8, 9, 3, 0, 1], 3, 6)": -1491,
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([1, 8, 9, 3, 0, 1], 3, 6)": -1498,
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([1, 8, 9, 3, 0, 1], 3, 6)": -1505,
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([1, 8, 9, 3, 0, 1], 3, 6)": -1513,
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([1, 8, 9, 3, 0, 1], 3, 6)": -1520,
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([1, 8, 9, 3, 0, 1], 3, 6)": -1527,
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([1, 8, 9, 3, 0, 1], 3, 6)": -1534,
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([1, 8, 9, 3, 0, 1], 3, 6)": -1542,
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([1, 8, 9, 3, 0, 1], 3, 6)": -1549,
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_return([1, 8, 9, 3, 0, 1], 3, 6)": -1556,
        "outlier_run_signal_density_band_span_gap_delta_balance_return([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_return([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_return([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([1, 8, 9, 3, 0, 1], 3, 6)": -1563,
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([1, 8, 9, 3, 0, 1], 3, 6)": -1571,
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([1, 8, 9, 3, 0, 1], 3, 6)": -1578,
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([1, 8, 9, 3, 0, 1], 3, 6)": -1585,
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([1, 8, 9, 3, 0, 1], 3, 6)": -1593,
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([1, 8, 9, 3, 0, 1], 3, 6)": -1600,
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([1, 8, 9, 3, 0, 1], 3, 6)": -1607,
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([1, 8, 9, 3, 0, 1], 3, 6)": -1614,
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([1, 8, 9, 3, 0, 1], 3, 6)": -1622,
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([1, 8, 9, 3, 0, 1], 3, 6)": -1629,
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([1, 8, 9, 3, 0, 1], 3, 6)": -1636,
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([1, 8, 9, 3, 0, 1], 3, 6)": -1643,
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([1, 8, 9, 3, 0, 1], 3, 6)": -1651,
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([1, 8, 9, 3, 0, 1], 3, 6)": -1658,
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([1, 8, 9, 3, 0, 1], 3, 6)": -1665,
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([1, 8, 9, 3, 0, 1], 3, 6)": -1672,
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([1, 8, 9, 3, 0, 1], 3, 6)": -1680,
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([1, 8, 9, 3, 0, 1], 3, 6)": -1687,
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([1, 8, 9, 3, 0, 1], 3, 6)": -1694,
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([1, 8, 9, 3, 0, 1], 3, 6)": -1701,
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([1, 8, 9, 3, 0, 1], 3, 6)": -1709,
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([1, 8, 9, 3, 0, 1], 3, 6)": -1716,
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([1, 8, 9, 3, 0, 1], 3, 6)": -1723,
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([1, 8, 9, 3, 0, 1], 3, 6)": -1730,
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([1, 8, 9, 3, 0, 1], 3, 6)": -1738,
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([1, 8, 9, 3, 0, 1], 3, 6)": -1745,
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([1, 8, 9, 3, 0, 1], 3, 6)": -1752,
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([1, 8, 9, 3, 0, 1], 3, 6)": -1759,
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([1, 8, 9, 3, 0, 1], 3, 6)": -1767,
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([1, 8, 9, 3, 0, 1], 3, 6)": -1774,
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_power([1, 8, 9, 3, 0, 1], 3, 6)": -1781,
        "outlier_run_signal_density_band_span_gap_delta_balance_power([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_power([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_power([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_force([1, 8, 9, 3, 0, 1], 3, 6)": -1788,
        "outlier_run_signal_density_band_span_gap_delta_balance_force([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_force([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_force([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([1, 8, 9, 3, 0, 1], 3, 6)": -1796,
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([1, 8, 9, 3, 0, 1], 3, 6)": -1803,
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([1, 8, 9, 3, 0, 1], 3, 6)": -1810,
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_work([1, 8, 9, 3, 0, 1], 3, 6)": -1817,
        "outlier_run_signal_density_band_span_gap_delta_balance_work([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_work([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_work([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([1, 8, 9, 3, 0, 1], 3, 6)": -1825,
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([1, 8, 9, 3, 0, 1], 3, 6)": -1832,
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([1, 8, 9, 3, 0, 1], 3, 6)": -1839,
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([1, 8, 9, 3, 0, 1], 3, 6)": -1846,
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([1, 8, 9, 3, 0, 1], 3, 6)": -1854,
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_char([1, 8, 9, 3, 0, 1], 3, 6)": -1861,
        "outlier_run_signal_density_band_span_gap_delta_balance_char([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_char([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_char([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([1, 8, 9, 3, 0, 1], 3, 6)": -1868,
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([1, 8, 9, 3, 0, 1], 3, 6)": -1875,
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([1, 8, 9, 3, 0, 1], 3, 6)": -1883,
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([1, 8, 9, 3, 0, 1], 3, 6)": -1890,
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([1, 8, 9, 3, 0, 1], 3, 6)": -1897,
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([1, 8, 9, 3, 0, 1], 3, 6)": -1904,
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([1, 8, 9, 3, 0, 1], 3, 6)": -1912,
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([1, 8, 9, 3, 0, 1], 3, 6)": -1919,
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([1, 8, 9, 3, 0, 1], 3, 6)": -1926,
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([1, 8, 9, 3, 0, 1], 3, 6)": -1933,
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([1, 8, 9, 3, 0, 1], 3, 6)": -1941,
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([1, 8, 9, 3, 0, 1], 3, 6)": -1948,
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([1, 8, 9, 3, 0, 1], 3, 6)": -1955,
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([1, 8, 9, 3, 0, 1], 3, 6)": -1962,
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_air([1, 8, 9, 3, 0, 1], 3, 6)": -1970,
        "outlier_run_signal_density_band_span_gap_delta_balance_air([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_air([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_air([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([1, 8, 9, 3, 0, 1], 3, 6)": -1977,
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([1, 8, 9, 3, 0, 1], 3, 6)": -1984,
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([1, 8, 9, 3, 0, 1], 3, 6)": -1991,
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([1, 8, 9, 3, 0, 1], 3, 6)": -1999,
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([1, 8, 9, 3, 0, 1], 3, 6)": -2006,
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([1, 8, 9, 3, 0, 1], 3, 6)": -2013,
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([1, 8, 9, 3, 0, 1], 3, 6)": -2020,
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([1, 8, 9, 3, 0, 1], 3, 6)": -2028,
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([1, 8, 9, 3, 0, 1], 3, 6)": -2035,
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([1, 8, 9, 3, 0, 1], 3, 6)": -2042,
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([1, 8, 9, 3, 0, 1], 3, 6)": -2049,
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([1, 8, 9, 3, 0, 1], 3, 6)": -2057,
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([1, 8, 9, 3, 0, 1], 3, 6)": -2064,
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([1, 8, 9, 3, 0, 1], 3, 6)": -2071,
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([1, 8, 9, 3, 0, 1], 3, 6)": -2078,
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([1, 8, 9, 3, 0, 1], 3, 6)": -2086,
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([1, 8, 9, 3, 0, 1], 3, 6)": -2093,
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([1, 8, 9, 3, 0, 1], 3, 6)": -2100,
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([1, 8, 9, 3, 0, 1], 3, 6)": -2107,
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([1, 8, 9, 3, 0, 1], 3, 6)": -2115,
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([1, 8, 9, 3, 0, 1], 3, 6)": -2122,
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([1, 8, 9, 3, 0, 1], 3, 6)": -2129,
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([1, 8, 9, 3, 0, 1], 3, 6)": -2136,
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([1, 8, 9, 3, 0, 1], 3, 6)": -2144,
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([1, 8, 9, 3, 0, 1], 3, 6)": -2151,
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([1, 8, 9, 3, 0, 1], 3, 6)": -2158,
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([1, 8, 9, 3, 0, 1], 3, 6)": -2165,
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([1, 8, 9, 3, 0, 1], 3, 6)": -2173,
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([1, 8, 9, 3, 0, 1], 3, 6)": -2180,
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([1, 8, 9, 3, 0, 1], 3, 6)": -2187,
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_key([1, 8, 9, 3, 0, 1], 3, 6)": -2194,
        "outlier_run_signal_density_band_span_gap_delta_balance_key([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_key([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_key([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_code([1, 8, 9, 3, 0, 1], 3, 6)": -2202,
        "outlier_run_signal_density_band_span_gap_delta_balance_code([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_code([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_code([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([1, 8, 9, 3, 0, 1], 3, 6)": -2209,
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_token([1, 8, 9, 3, 0, 1], 3, 6)": -2216,
        "outlier_run_signal_density_band_span_gap_delta_balance_token([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_token([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_token([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([1, 8, 9, 3, 0, 1], 3, 6)": -2223,
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([1, 8, 9, 3, 0, 1], 3, 6)": -2231,
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([1, 8, 9, 3, 0, 1], 3, 6)": -2238,
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([1, 8, 9, 3, 0, 1], 3, 6)": -2245,
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([1, 8, 9, 3, 0, 1], 3, 6)": -2252,
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([1, 8, 9, 3, 0, 1], 3, 6)": -2260,
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([1, 8, 9, 3, 0, 1], 3, 6)": -2267,
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([], 3, 6)": 0,
...
def test_c_hosted_rustic_interpreter_evaluates_balance_keeper_helpers(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -2783,
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([7, 8], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([3], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([1, 8, 9, 3, 0, 1], 3, 6)": -2259,
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([3, 4, 5], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([7], 3, 6)": 0,
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([], 3, 6)": 0,
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_keeper(clamp([9, 1, 5, 3], 2, 6), 3, 5)": -3095,
    }
...
def test_c_hosted_rustic_interpreter_rejects_invalid_balance_keeper_arguments(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    cases = {
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_keeper([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_keeper([1], 0)": "wrong argument count",
    }
...
def test_c_hosted_rustic_interpreter_releases_balance_assert_temporaries(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_assert([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -183950,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_assert([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -149240,
    }
...
def test_c_hosted_rustic_interpreter_releases_balance_keeper_temporaries(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_keeper([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -180895,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_keeper([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -146835,
    }
...
def test_c_hosted_rustic_interpreter_releases_balance_verify_temporaries(tmp_path):
    binary = compile_rustic_driver(tmp_path)
    expectations = {
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_verify([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -184535,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_verify([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -149760,
    }
...
def test_c_hosted_rustic_interpreter_runs_array_statistics_showcase_fixture(tmp_path):
    ...
    assert cases == [
        ...
        ("threshold_run_signal_density_band_span_gap_delta_balance_note(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_note(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2000),
        ("threshold_run_signal_density_band_span_gap_delta_balance_tone(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_tone(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2012),
        ("threshold_run_signal_density_band_span_gap_delta_balance_chord(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_chord(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2019),
        ("threshold_run_signal_density_band_span_gap_delta_balance_melody(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_melody(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2031),
        ("threshold_run_signal_density_band_span_gap_delta_balance_song(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_song(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2043),
        ("threshold_run_signal_density_band_span_gap_delta_balance_verse(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_verse(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2050),
        ("threshold_run_signal_density_band_span_gap_delta_balance_chorus(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_chorus(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2062),
        ("threshold_run_signal_density_band_span_gap_delta_balance_bridge(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_bridge(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2074),
        ("threshold_run_signal_density_band_span_gap_delta_balance_coda(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_coda(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2081),
        ("threshold_run_signal_density_band_span_gap_delta_balance_outro(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_outro(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2093),
        ("threshold_run_signal_density_band_span_gap_delta_balance_finale(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_finale(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2105),
        ("threshold_run_signal_density_band_span_gap_delta_balance_encore(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_encore(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2113),
        ("threshold_run_signal_density_band_span_gap_delta_balance_replay(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_replay(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2120),
        ("threshold_run_signal_density_band_span_gap_delta_balance_rerun(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_rerun(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2132),
        ("threshold_run_signal_density_band_span_gap_delta_balance_repeat(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_repeat(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2144),
        ("threshold_run_signal_density_band_span_gap_delta_balance_return(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_return(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2152),
        ("threshold_run_signal_density_band_span_gap_delta_balance_cycle(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_cycle(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2159),
        ("threshold_run_signal_density_band_span_gap_delta_balance_orbit(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_orbit(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2171),
        ("threshold_run_signal_density_band_span_gap_delta_balance_turn(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_turn(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2183),
        ("threshold_run_signal_density_band_span_gap_delta_balance_spin(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_spin(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2190),
        ("threshold_run_signal_density_band_span_gap_delta_balance_twist(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_twist(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2202),
        ("threshold_run_signal_density_band_span_gap_delta_balance_whirl(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_whirl(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2214),
        ("threshold_run_signal_density_band_span_gap_delta_balance_swirl(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_swirl(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2222),
        ("threshold_run_signal_density_band_span_gap_delta_balance_vortex(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_vortex(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2229),
        ("threshold_run_signal_density_band_span_gap_delta_balance_eddy(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_eddy(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2241),
        ("threshold_run_signal_density_band_span_gap_delta_balance_gyre(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_gyre(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2253),
        ("threshold_run_signal_density_band_span_gap_delta_balance_spiral(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_spiral(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2261),
        ("threshold_run_signal_density_band_span_gap_delta_balance_helix(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_helix(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2268),
        ("threshold_run_signal_density_band_span_gap_delta_balance_coil(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_coil(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2280),
        ("threshold_run_signal_density_band_span_gap_delta_balance_curl(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_curl(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2292),
        ("threshold_run_signal_density_band_span_gap_delta_balance_bend(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_bend(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2300),
        ("threshold_run_signal_density_band_span_gap_delta_balance_curve(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_curve(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2307),
        ("threshold_run_signal_density_band_span_gap_delta_balance_sweep(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_sweep(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2319),
        ("threshold_run_signal_density_band_span_gap_delta_balance_swing(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_swing(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2331),
        ("threshold_run_signal_density_band_span_gap_delta_balance_sway(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_sway(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2339),
        ("threshold_run_signal_density_band_span_gap_delta_balance_veer(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_veer(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2346),
        ("threshold_run_signal_density_band_span_gap_delta_balance_glide(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_glide(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2358),
        ("threshold_run_signal_density_band_span_gap_delta_balance_slide(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_slide(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2370),
        ("threshold_run_signal_density_band_span_gap_delta_balance_slip(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_slip(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2378),
        ("threshold_run_signal_density_band_span_gap_delta_balance_skid(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_skid(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2385),
        ("threshold_run_signal_density_band_span_gap_delta_balance_skate(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_skate(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2397),
        ("threshold_run_signal_density_band_span_gap_delta_balance_coast(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_coast(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2409),
        ("threshold_run_signal_density_band_span_gap_delta_balance_cruise(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_cruise(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2417),
        ("threshold_run_signal_density_band_span_gap_delta_balance_drive(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_drive(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2424),
        ("threshold_run_signal_density_band_span_gap_delta_balance_motor(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_motor(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2436),
        ("threshold_run_signal_density_band_span_gap_delta_balance_engine(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_engine(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2448),
        ("threshold_run_signal_density_band_span_gap_delta_balance_power(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_power(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2456),
        ("threshold_run_signal_density_band_span_gap_delta_balance_force(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_force(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2463),
        ("threshold_run_signal_density_band_span_gap_delta_balance_thrust(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_thrust(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2475),
        ("threshold_run_signal_density_band_span_gap_delta_balance_torque(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_torque(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2487),
        ("threshold_run_signal_density_band_span_gap_delta_balance_moment(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_moment(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2495),
        ("threshold_run_signal_density_band_span_gap_delta_balance_work(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_work(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2502),
        ("threshold_run_signal_density_band_span_gap_delta_balance_energy(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_energy(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2514),
        ("threshold_run_signal_density_band_span_gap_delta_balance_heat(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_heat(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2526),
        ("threshold_run_signal_density_band_span_gap_delta_balance_warm(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_warm(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2534),
        ("threshold_run_signal_density_band_span_gap_delta_balance_hot(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_hot(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2541),
        ("threshold_run_signal_density_band_span_gap_delta_balance_burn(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_burn(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2553),
        ("threshold_run_signal_density_band_span_gap_delta_balance_char(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_char(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2565),
        ("threshold_run_signal_density_band_span_gap_delta_balance_coal(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_coal(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2573),
        ("threshold_run_signal_density_band_span_gap_delta_balance_coke(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_coke(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2580),
        ("threshold_run_signal_density_band_span_gap_delta_balance_fuel(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_fuel(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2592),
        ("threshold_run_signal_density_band_span_gap_delta_balance_gas(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_gas(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2604),
        ("threshold_run_signal_density_band_span_gap_delta_balance_vapor(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_vapor(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2612),
        ("threshold_run_signal_density_band_span_gap_delta_balance_mist(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_mist(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2619),
        ("threshold_run_signal_density_band_span_gap_delta_balance_fog(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_fog(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2631),
        ("threshold_run_signal_density_band_span_gap_delta_balance_cloud(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_cloud(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2643),
        ("threshold_run_signal_density_band_span_gap_delta_balance_rain(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_rain(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2651),
        ("threshold_run_signal_density_band_span_gap_delta_balance_storm(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_storm(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2658),
        ("threshold_run_signal_density_band_span_gap_delta_balance_wind(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_wind(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2670),
        ("threshold_run_signal_density_band_span_gap_delta_balance_gust(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_gust(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2682),
        ("threshold_run_signal_density_band_span_gap_delta_balance_breeze(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_breeze(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2690),
        ("threshold_run_signal_density_band_span_gap_delta_balance_draft(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_draft(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2697),
        ("threshold_run_signal_density_band_span_gap_delta_balance_air(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_air(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2709),
        ("threshold_run_signal_density_band_span_gap_delta_balance_flow(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_flow(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2721),
        ("threshold_run_signal_density_band_span_gap_delta_balance_jet(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_jet(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2729),
        ("threshold_run_signal_density_band_span_gap_delta_balance_wake(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_wake(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2736),
        ("threshold_run_signal_density_band_span_gap_delta_balance_surge(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_surge(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2748),
        ("threshold_run_signal_density_band_span_gap_delta_balance_swell(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_swell(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2760),
        ("threshold_run_signal_density_band_span_gap_delta_balance_tide(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_tide(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2768),
        ("threshold_run_signal_density_band_span_gap_delta_balance_ebb(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_ebb(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2775),
        ("threshold_run_signal_density_band_span_gap_delta_balance_flood(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_flood(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2787),
        ("threshold_run_signal_density_band_span_gap_delta_balance_deluge(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_deluge(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2799),
        ("threshold_run_signal_density_band_span_gap_delta_balance_ripple(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_ripple(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2807),
        ("threshold_run_signal_density_band_span_gap_delta_balance_rill(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_rill(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2814),
        ("threshold_run_signal_density_band_span_gap_delta_balance_canal(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_canal(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2826),
        ("threshold_run_signal_density_band_span_gap_delta_balance_ditch(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_ditch(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2838),
        ("threshold_run_signal_density_band_span_gap_delta_balance_drain(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_drain(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2846),
        ("threshold_run_signal_density_band_span_gap_delta_balance_sewer(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_sewer(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2853),
        ("threshold_run_signal_density_band_span_gap_delta_balance_pipe(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_pipe(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2865),
        ("threshold_run_signal_density_band_span_gap_delta_balance_tube(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_tube(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2877),
        ("threshold_run_signal_density_band_span_gap_delta_balance_hose(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_hose(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2885),
        ("threshold_run_signal_density_band_span_gap_delta_balance_valve(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_valve(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2892),
        ("threshold_run_signal_density_band_span_gap_delta_balance_pump(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_pump(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2904),
        ("threshold_run_signal_density_band_span_gap_delta_balance_piston(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_piston(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2916),
        ("threshold_run_signal_density_band_span_gap_delta_balance_rod(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_rod(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2924),
        ("threshold_run_signal_density_band_span_gap_delta_balance_shaft(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_shaft(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2931),
        ("threshold_run_signal_density_band_span_gap_delta_balance_gear(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_gear(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2943),
        ("threshold_run_signal_density_band_span_gap_delta_balance_cog(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_cog(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2955),
        ("threshold_run_signal_density_band_span_gap_delta_balance_pinion(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_pinion(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2963),
        ("threshold_run_signal_density_band_span_gap_delta_balance_tooth(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_tooth(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2970),
        ("threshold_run_signal_density_band_span_gap_delta_balance_rack(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_rack(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2982),
        ("threshold_run_signal_density_band_span_gap_delta_balance_notch(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_notch(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -2994),
        ("threshold_run_signal_density_band_span_gap_delta_balance_slot(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_slot(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3002),
        ("threshold_run_signal_density_band_span_gap_delta_balance_key(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_key(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3009),
        ("threshold_run_signal_density_band_span_gap_delta_balance_code(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_code(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3021),
        ("threshold_run_signal_density_band_span_gap_delta_balance_cipher(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_cipher(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3033),
        ("threshold_run_signal_density_band_span_gap_delta_balance_token(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_token(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3041),
        ("threshold_run_signal_density_band_span_gap_delta_balance_nonce(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_nonce(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3048),
        ("threshold_run_signal_density_band_span_gap_delta_balance_secret(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_secret(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3060),
        ("threshold_run_signal_density_band_span_gap_delta_balance_vault(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_vault(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3072),
        ("threshold_run_signal_density_band_span_gap_delta_balance_safe(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_safe(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3080),
        ("threshold_run_signal_density_band_span_gap_delta_balance_secure(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_secure(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3087),
        ("threshold_run_signal_density_band_span_gap_delta_balance_sentry(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_sentry(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3099),
        ("threshold_run_signal_density_band_span_gap_delta_balance_warden(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_warden(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3111),
        ("threshold_run_signal_density_band_span_gap_delta_balance_watch(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_watch(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3118),
        ("threshold_run_signal_density_band_span_gap_delta_balance_keeper(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_keeper(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3095),
        ("threshold_run_signal_density_band_span_gap_delta_balance_patrol(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_patrol(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3099),
        ("threshold_run_signal_density_band_span_gap_delta_balance_post(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_post(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3107),
        ("threshold_run_signal_density_band_span_gap_delta_balance_audit(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_audit(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3114),
        ("threshold_run_signal_density_band_span_gap_delta_balance_proof(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_proof(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3126),
        ("threshold_run_signal_density_band_span_gap_delta_balance_claim(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_claim(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3134),
        ("threshold_run_signal_density_band_span_gap_delta_balance_assert(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_assert(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3141),
        ("threshold_run_signal_density_band_span_gap_delta_balance_verify(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_verify(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3153),
        ("threshold_run_signal_density_band_span_gap_delta_balance_assure(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_assure(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3165),
        ("threshold_run_signal_density_band_span_gap_delta_balance_check(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_check(clamp([9, 1, 5, 3], 2, 6), 3, 5)", -3173),
...
def test_c_hosted_rustic_interpreter_rejects_invalid_reverse_take_arguments(tmp_path):
    ...
    cases = {
        ...
        "threshold_run_signal_density_band_span_gap_delta_balance_note(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_note([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_note([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_note([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_tone(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tone([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_chord(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_chord([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_melody(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_melody([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_song(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_song([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_song([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_song([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_verse(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_verse([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_chorus([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_bridge([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_coda(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coda([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_outro(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_outro([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_finale(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_finale([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_encore(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_encore([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_replay(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_replay([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rerun([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_repeat([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_return(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_return([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_return([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_return([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cycle([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_orbit([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_turn(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_turn([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_spin(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_spin([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_twist(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_twist([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_whirl([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swirl([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vortex([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_eddy([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gyre([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_spiral([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_helix(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_helix([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_coil(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coil([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_curl(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_curl([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_bend(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_bend([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_curve(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_curve([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sweep([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_swing(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swing([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_sway(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sway([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_veer(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_veer([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_glide(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_glide([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_slide(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slide([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_slip(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slip([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_skid(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_skid([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_skate(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_skate([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_coast(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coast([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cruise([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_drive(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_drive([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_motor(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_motor([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_engine(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_engine([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_power(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_power([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_power([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_power([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_force(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_force([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_force([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_force([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_thrust([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_torque(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_torque([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_moment(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_moment([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_work(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_work([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_work([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_work([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_energy(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_energy([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_heat(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_heat([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_warm(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_warm([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_hot(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_hot([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_burn(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_burn([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_char(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_char([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_char([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_char([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_coal(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coal([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_coke(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_coke([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_fuel([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_gas(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gas([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vapor([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_mist(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_mist([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_fog(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_fog([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cloud([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_rain(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rain([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_storm(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_storm([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_wind(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_wind([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_gust(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gust([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_breeze([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_draft(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_draft([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_air(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_air([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_air([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_air([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_flow(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_flow([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_jet(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_jet([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_wake(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_wake([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_surge(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_surge([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_swell(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_swell([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_tide(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tide([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ebb([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_flood(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_flood([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_deluge([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ripple([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_rill(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rill([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_canal(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_canal([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_ditch([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_drain(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_drain([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sewer([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pipe([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_tube(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tube([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_hose(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_hose([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_valve(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_valve([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_pump(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pump([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_piston(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_piston([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_rod(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rod([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_shaft([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_gear(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_gear([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_cog(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cog([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_pinion([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_tooth([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_rack(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_rack([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_notch(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_notch([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_slot(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_slot([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_key(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_key([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_key([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_key([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_code(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_code([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_code([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_code([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_cipher([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_token(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_token([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_token([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_token([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_nonce([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_secret(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_secret([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_vault(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_vault([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_safe(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_safe([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_secure(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_secure([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_sentry([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_warden(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_warden([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([1], 0)": "wrong argument count",
        "threshold_run_signal_density_band_span_gap_delta_balance_watch(1, 0, 1)": "expected array",
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([1], [0], 1)": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([1], 0, [1])": "expected integer",
        "threshold_run_signal_density_band_span_gap_delta_balance_watch([1], 0)": "wrong argument count",
        ...
        "outlier_run_signal_density_band_span_gap_delta_balance_note(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_note([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_note([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_note([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_tone(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tone([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_chord(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_chord([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_melody(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_melody([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_song(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_song([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_song([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_song([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_verse(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_verse([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_chorus([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_bridge([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_coda(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coda([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_outro(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_outro([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_finale(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_finale([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_encore(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_encore([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_replay(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_replay([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rerun([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_repeat([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_return(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_return([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_return([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_return([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cycle([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_orbit([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_turn(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_turn([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_spin(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_spin([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_twist(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_twist([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_whirl([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swirl([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vortex([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_eddy([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gyre([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_spiral([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_helix(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_helix([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_coil(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coil([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_curl(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_curl([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_bend(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_bend([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_curve(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_curve([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sweep([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_swing(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swing([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_sway(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sway([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_veer(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_veer([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_glide(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_glide([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_slide(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slide([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_slip(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slip([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_skid(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_skid([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_skate(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_skate([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_coast(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coast([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cruise([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_drive(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_drive([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_motor(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_motor([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_engine(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_engine([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_power(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_power([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_power([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_power([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_force(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_force([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_force([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_force([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_thrust([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_torque(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_torque([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_moment(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_moment([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_work(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_work([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_work([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_work([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_energy(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_energy([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_heat(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_heat([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_warm(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_warm([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_hot(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_hot([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_burn(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_burn([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_char(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_char([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_char([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_char([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_coal(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coal([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_coke(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_coke([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_fuel([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_gas(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gas([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vapor([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_mist(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_mist([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_fog(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_fog([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cloud([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_rain(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rain([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_storm(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_storm([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_wind(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_wind([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_gust(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gust([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_breeze([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_draft(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_draft([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_air(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_air([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_air([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_air([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_flow(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_flow([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_jet(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_jet([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_wake(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_wake([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_surge(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_surge([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_swell(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_swell([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_tide(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tide([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ebb([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_flood(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_flood([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_deluge([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ripple([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_rill(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rill([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_canal(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_canal([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_ditch([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_drain(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_drain([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sewer([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pipe([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_tube(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tube([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_hose(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_hose([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_valve(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_valve([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_pump(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pump([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_piston(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_piston([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_rod(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rod([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_shaft([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_gear(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_gear([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_cog(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cog([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_pinion([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_tooth([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_rack(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_rack([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_notch(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_notch([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_slot(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_slot([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_key(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_key([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_key([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_key([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_code(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_code([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_code([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_code([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_cipher([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_token(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_token([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_token([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_token([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_nonce([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_secret(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_secret([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_vault(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_vault([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_safe(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_safe([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_secure(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_secure([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_sentry([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_warden(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_warden([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([1], 0)": "wrong argument count",
        "outlier_run_signal_density_band_span_gap_delta_balance_watch(1, 0, 1)": "expected array",
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([1], [0], 1)": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([1], 0, [1])": "expected integer",
        "outlier_run_signal_density_band_span_gap_delta_balance_watch([1], 0)": "wrong argument count",
...
def test_c_hosted_rustic_interpreter_releases_reverse_take_temporaries(tmp_path):
    ...
    expectations = {
        ...
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_note([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -117260,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_note([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -94055,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_tone([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -117715,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_tone([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -94510,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_chord([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -118365,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_chord([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -94965,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_melody([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -118950,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_melody([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -95485,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_song([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -119405,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_song([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -95940,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_verse([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -120055,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_verse([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -96395,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_chorus([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -120640,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_chorus([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -96915,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_bridge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -121095,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_bridge([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -97370,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_coda([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -121745,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_coda([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -97825,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_outro([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -122330,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_outro([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -98345,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_finale([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -122785,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_finale([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -98800,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_encore([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -123370,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_encore([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -99255,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_replay([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -124020,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_replay([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -99710,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_rerun([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -124605,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_rerun([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -100230,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_repeat([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -125060,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_repeat([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -100685,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_return([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -125645,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_return([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -101140,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_cycle([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -126295,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_cycle([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -101595,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_orbit([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -126880,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_orbit([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -102115,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_turn([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -127335,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_turn([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -102570,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_spin([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -127985,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_spin([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -103025,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_twist([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -128570,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_twist([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -103545,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_whirl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -129025,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_whirl([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -104000,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_swirl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -129610,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_swirl([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -104455,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_vortex([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -130260,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_vortex([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -104910,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_eddy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -130845,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_eddy([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -105430,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_gyre([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -131300,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_gyre([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -105885,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_spiral([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -131885,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_spiral([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -106340,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_helix([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -132535,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_helix([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -106795,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_coil([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -133120,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_coil([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -107315,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_curl([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -133575,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_curl([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -107770,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_bend([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -134160,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_bend([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -108225,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_curve([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -134810,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_curve([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -108680,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_sweep([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -135395,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_sweep([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -109200,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_swing([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -135850,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_swing([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -109655,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_sway([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -136435,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_sway([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -110110,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_veer([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -137085,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_veer([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -110565,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_glide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -137670,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_glide([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -111085,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_slide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -138125,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_slide([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -111540,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_slip([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -138710,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_slip([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -111995,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_skid([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -139360,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_skid([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -112450,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_skate([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -139945,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_skate([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -112970,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_coast([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -140400,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_coast([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -113425,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_cruise([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -140985,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_cruise([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -113880,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_drive([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -141635,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_drive([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -114335,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_motor([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -142220,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_motor([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -114855,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_engine([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -142675,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_engine([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -115310,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_power([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -143260,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_power([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -115765,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_force([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -143910,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_force([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -116220,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_thrust([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -144495,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_thrust([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -116740,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_torque([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -144950,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_torque([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -117195,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_moment([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -145535,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_moment([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -117650,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_work([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -146185,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_work([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -118105,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_energy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -146770,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_energy([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -118625,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_heat([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -147225,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_heat([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -119080,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_warm([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -147810,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_warm([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -119535,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_hot([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -148460,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_hot([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -119990,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_burn([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -149045,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_burn([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -120510,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_char([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -149500,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_char([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -120965,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_coal([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -150085,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_coal([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -121420,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_coke([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -150735,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_coke([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -121875,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_fuel([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -151320,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_fuel([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -122395,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_gas([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -151775,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_gas([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -122850,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_vapor([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -152360,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_vapor([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -123305,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_mist([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -153010,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_mist([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -123760,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_fog([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -153595,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_fog([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -124280,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_cloud([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -154050,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_cloud([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -124735,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_rain([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -154635,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_rain([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -125190,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_storm([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -155285,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_storm([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -125645,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_wind([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -155870,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_wind([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -126165,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_gust([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -156325,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_gust([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -126620,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_breeze([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -156910,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_breeze([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -127075,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_draft([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -157560,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_draft([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -127530,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_air([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -158145,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_air([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -128050,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_flow([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -158600,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_flow([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -128505,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_jet([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -159185,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_jet([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -128960,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_wake([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -159835,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_wake([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -129415,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_surge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -160420,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_surge([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -129935,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_swell([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -160875,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_swell([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -130390,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_tide([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -161460,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_tide([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -130845,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_ebb([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -162110,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_ebb([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -131300,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_flood([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -162695,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_flood([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -131820,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_deluge([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -163150,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_deluge([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -132275,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_ripple([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -163735,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_ripple([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -132730,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_rill([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -164385,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_rill([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -133185,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_canal([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -164970,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_canal([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -133705,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_ditch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -165425,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_ditch([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -134160,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_drain([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -166010,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_drain([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -134615,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_sewer([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -166660,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_sewer([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -135070,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_pipe([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -167245,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_pipe([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -135590,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_tube([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -167700,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_tube([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -136045,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_hose([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -168285,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_hose([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -136500,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_valve([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -168935,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_valve([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -136955,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_pump([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -169520,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_pump([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -137475,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_piston([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -169975,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_piston([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -137930,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_rod([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -170560,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_rod([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -138385,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_shaft([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -171210,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_shaft([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -138840,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_gear([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -171795,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_gear([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -139360,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_cog([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -172250,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_cog([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -139815,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_pinion([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -172835,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_pinion([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -140270,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_tooth([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -173485,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_tooth([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -140725,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_rack([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -174070,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_rack([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -141245,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_notch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -174525,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_notch([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -141700,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_slot([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -175110,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_slot([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -142155,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_key([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -175760,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_key([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -142610,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_code([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -176345,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_code([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -143130,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_cipher([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -176800,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_cipher([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -143585,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_token([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -177385,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_token([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -144040,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_nonce([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -178035,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_nonce([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -144495,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_secret([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -178620,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_secret([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -145015,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_vault([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -179075,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_vault([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -145470,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_safe([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -179660,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_safe([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -145925,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_secure([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -180310,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_secure([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -146380,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_sentry([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -180895,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_sentry([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -146900,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_warden([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -181350,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_warden([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -147355,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_watch([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -182000,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_watch([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -147810,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_keeper([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -180895,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_keeper([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -146835,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_patrol([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -180895,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_patrol([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -146900,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_post([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -181480,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_post([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -147355,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_audit([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -182130,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_audit([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -147810,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_proof([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -182715,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_proof([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -148330,
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_claim([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -183300,
        "let n = 0; let total = 0; while n < 65 { total = total + outlier_run_signal_density_band_span_gap_delta_balance_claim([1, 8, 9, 3, 0, 1], 3, 6); n = n + 1; }; total": -148785,
