...
def test_c_hosted_rustic_interpreter_computes_array_threshold_validation_helpers(tmp_path):
    ...
    expectations = {
        ...
        "threshold_run_signal_density_band_span_gap_delta_balance_canopy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6)": -1131,
        ...
        "threshold_run_signal_density_band_span_gap_delta_balance_canopy(clamp([9, 1, 5, 3], 2, 6), 2, 6) + outlier_run_signal_density_band_span_gap_delta_balance_canopy(clamp([9, 1, 5, 3], 2, 6), 3, 5)": -1258,
...
def test_c_hosted_rustic_interpreter_releases_reverse_take_temporaries(tmp_path):
    ...
    expectations = {
        ...
        "let n = 0; let total = 0; while n < 65 { total = total + threshold_run_signal_density_band_span_gap_delta_balance_canopy([3, 4, 7, 3, 5, 6, 9, 4], 3, 6); n = n + 1; }; total": -73515,
