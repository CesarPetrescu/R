...
- `docs/release-checklist.md` documents the external release checklist fixture workflow and `docs/release/checklist.json` stores a checked docs-path release checklist fixture that Docker verifies with `--release-tag-fixture-path docs/release/checklist.json`.
