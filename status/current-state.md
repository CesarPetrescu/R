...
- `r_project.memory.render_layout(name, layout)` renders named struct/vector layouts as stable, line-oriented debug memory maps with offsets, padding, sizes, and alignment.
