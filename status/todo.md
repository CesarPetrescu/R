...
3. Add a release section writer matrix row generator if release docs need the same copy/paste preview workflow now available for dashboard variant rows.
