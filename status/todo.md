...
1. Add collection ordering/comparison helpers to Rustic, such as `sort(array)` or `dedup(array)`, with tests proving empty-array behavior, composition with `find`/`contains_any`, cap preservation, and array-slot cleanup.
