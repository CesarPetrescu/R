...
2. Add richer collection showcase helpers to Rustic, such as map/filter-style loops over arrays or collection filter/count helpers, with tests proving runaway allocation remains bounded.
