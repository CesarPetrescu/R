...
2. Add release automation index guard coverage for requiring named profile blocks if release docs eventually need multiple simultaneous preview-version profiles in the same document.
3. Add a dashboard automation index guard for separately named profile sections if dashboard docs eventually need several preview variants in the same automation page at once.
