...
2. Add richer collection showcase helpers to Rustic, such as `min(array)`/`max(array)` or map/filter-style loops over arrays, with tests proving runaway allocation remains bounded.
