...
2. Continue extending the Rustic interpreter with a bounded, test-first product-depth helper family after the balance-verify helpers; next candidate `balance-guard` is identifier-safe (62/60 characters for threshold/outlier) and should preserve direct/edge, invalid-argument, showcase, and cleanup diagnostics.
