...
2. Add a dashboard section registry guard if future dashboard docs add a standalone multi-section registry beyond `docs/dashboard-example-fixtures.md`.
3. Add a release-section version matrix option if future release docs need a configurable preview version other than the current fixed `0.2.0` smoke target.
