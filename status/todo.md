...
2. Add a release automation surface link/command row writer if future release docs add new standalone surfaces beyond `docs/release-section-writer-matrix.md`.
