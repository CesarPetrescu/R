...
2. Add richer collection showcase helpers to Rustic, such as map/filter-style loops over arrays or compact collection summary helpers, with tests proving runaway allocation remains bounded.
