...
3. Add a release readiness index that links the release checklist fixture docs with version/tag guard commands if release consumers need one entry point.
