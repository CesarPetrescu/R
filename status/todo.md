...
1. Add richer collection comparison helpers to Rustic, such as `equals(array, array)` or `starts_with(array, prefix)`, with tests proving empty-array behavior, sorted/deduped composition, argument diagnostics, and array-slot cleanup.
