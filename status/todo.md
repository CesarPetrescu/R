...
1. Add modulo/remainder arithmetic (`%`) to the C-hosted Rustic interpreter so recursive and loop examples can express divisibility checks without awkward subtraction chains.
