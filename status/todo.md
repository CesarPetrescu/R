...
2. Add tagged nested-layout renderers that recursively include child struct/vector memory maps when future runtime objects need full source-level traceability.
