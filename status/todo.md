...
2. Add richer collection showcase helpers to Rustic, such as `all(array, value)`/`any(array, value)` or map/filter-style loops over arrays, with tests proving runaway allocation remains bounded.
