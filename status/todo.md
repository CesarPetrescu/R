...
3. Continue extending the Rustic interpreter with a bounded, test-first product-depth helper family after the balance-check helpers; choose an identifier-safe suffix after checking the 63-character cap and preserve direct/edge, invalid-argument, showcase, and cleanup diagnostics.
