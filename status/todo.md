...
3. Add dashboard-specific release/readiness index docs if external consumers need one landing page for `docs/usage-examples.md` and `docs/dashboard-schema.md`.
