...
- [release readiness index](../docs/release-index.md)
- [release checklist fixture docs](../docs/release-checklist.md)
- [release checklist JSON fixture](../docs/release/checklist.json)
- [release checklist examples](../docs/release-examples.md)
- [release example fixture registry](../docs/release-example-fixtures.md)
- [release example section registry](../docs/release-example-sections.md)
- [release section writer matrix](../docs/release-section-writer-matrix.md)
...
When release docs need several preview trains in one page, keep each train in a named profile block and guard that block directly:

### Release 0.3.0 preview profile
