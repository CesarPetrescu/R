...
The newest array-statistics helpers are `threshold_run_signal_density_band_span_gap_delta_balance_verify(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_verify(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_assure(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_assure(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_check(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_check(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_review(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_review(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_assess(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_assess(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_survey(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_survey(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_sample(array, min, max)`, `outlier_run_signal_density_band_span_gap_delta_balance_sample(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_case(array, min, max)`, and `outlier_run_signal_density_band_span_gap_delta_balance_case(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_item(array, min, max)`, and `outlier_run_signal_density_band_span_gap_delta_balance_item(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_unit(array, min, max)`, and `outlier_run_signal_density_band_span_gap_delta_balance_unit(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_part(array, min, max)`, and `outlier_run_signal_density_band_span_gap_delta_balance_part(array, min, max)`, `threshold_run_signal_density_band_span_gap_delta_balance_whole(array, min, max)`, and `outlier_run_signal_density_band_span_gap_delta_balance_whole(array, min, max)`. They extend the balance helper chain with matching-mass plus longest-run verify pressure followed by matching-mass plus shortest-run assure pressure, matching-mass plus matching-run-count check pressure, matching-mass plus transition-count review pressure, matching-mass plus longest-run assess pressure, matching-mass plus matching-run-count survey pressure, matching-mass plus transition-count sample pressure, and matching-mass plus longest-run case pressure followed by matching-mass plus shortest-run item pressure, followed by matching-mass plus matching-run-count unit pressure, matching-mass plus transition-count part pressure, and matching-mass plus longest-run whole pressure, and return `0` for empty, single-element, or no-match inputs.
...
host fixture. Recent signal-density band helpers include `threshold_run_signal_density_band_span_gap_delta_balance_fen(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_fen(array, min, max)` for matching-mass plus transition-count fen pressure, `threshold_run_signal_density_band_span_gap_delta_balance_pool(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_pool(array, min, max)` for matching-mass plus matching-run-count pool pressure, and `threshold_run_signal_density_band_span_gap_delta_balance_cove(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_cove(array, min, max)` for matching-mass plus transition-count cove pressure. The evaluator supports `+`, `-`, `*`, `/`, `%`, unary boolean negation `!`,
...
safety before larger statement forms or runtime objects are added. Recent signal-density band helpers include `threshold_run_signal_density_band_span_gap_delta_balance_fen(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_fen(array, min, max)` for matching-mass plus transition-count fen pressure, `threshold_run_signal_density_band_span_gap_delta_balance_pool(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_pool(array, min, max)` for matching-mass plus matching-run-count pool pressure, and `threshold_run_signal_density_band_span_gap_delta_balance_cove(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_cove(array, min, max)` for matching-mass plus transition-count cove pressure.
...
```json
{"active_blockers": [], "completed_backlog_items": 555, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 254, "next_item": null, "open": 0}, "P2": {"completed": 297, "next_item": null, "open": 0}}, "project_name": "R"}
```
