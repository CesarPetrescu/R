...
programs such as `1 + 2 * 3`, `let x = 2 + 3; x * 4`,
...
undefined-identifier diagnostics for reads and assignment targets. The pytest suite
compiles that C runtime with `cc -std=c99 -Wall -Wextra -Werror` so the showcase
proves end-to-end interpreted expressions, bindings, sequencing, and mutation
...
```json
{"active_blockers": [], "completed_backlog_items": 101, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 37, "next_item": null, "open": 0}, "P2": {"completed": 60, "next_item": null, "open": 0}}, "project_name": "R"}
```
