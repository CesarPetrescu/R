...
and `fn countdown(n) { if n == 0 { 7 } else { countdown(n - 1) } }; countdown(3)` from a C
...
recursive countdowns, and runaway loop/recursion
...
```json
{"active_blockers": [], "completed_backlog_items": 112, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 48, "next_item": null, "open": 0}, "P2": {"completed": 60, "next_item": null, "open": 0}}, "project_name": "R"}
```
