...
- a standalone release-example fixture index that can be audited against Docker coverage, a release example section registry for independently named Markdown snippets, a dashboard example fixture registry for split dashboard docs, a release examples path-safety audit guard for Markdown path override modes, an automation command index guard for combined docs, and an automation command fixture index guard for split-doc command coverage
