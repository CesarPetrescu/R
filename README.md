...
safety before larger statement forms or runtime objects are added. Recent signal-density band helpers also include `threshold_run_signal_density_band_span_gap_delta_balance_flare(array, min, max)` and `outlier_run_signal_density_band_span_gap_delta_balance_flare(array, min, max)` for matching mass plus transition-count flare pressure on top of the balance-spire score.
...
```json
{"active_blockers": [], "completed_backlog_items": 240, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 176, "next_item": null, "open": 0}, "P2": {"completed": 60, "next_item": null, "open": 0}}, "project_name": "R"}
```
