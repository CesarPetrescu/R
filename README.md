...
array reshaping/statistics showcase fixtures combining `chunk_count(...)`, `chunk_sum(...)`, `rotate(...)`, `rotate_right(...)`, `drop(...)`, `take(...)`, `window_sum(...)`, `prefix_sum(...)`, `adjacent_diff(...)`, `median(...)`, `variance_sum(...)`, `mode(...)`, `unique_count(...)`, `histogram_count(...)`, `histogram_values(...)`, `frequency_score(...)`, `histogram_pairs_score(...)`, `histogram_distance_score(...)`, `weighted_score(...)`, `nth_sorted(...)`, `top_count(...)`, `rank_of(...)`, `top_sum(...)`, and `clamp(...)`,
...
```json
{"active_blockers": [], "completed_backlog_items": 157, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 93, "next_item": null, "open": 0}, "P2": {"completed": 60, "next_item": null, "open": 0}}, "project_name": "R"}
```
