...
array reshaping showcase fixtures combining `chunk_count(...)`, `rotate(...)`, `drop(...)`, `take(...)`, and `window_sum(...)`,
...
```json
{"active_blockers": [], "completed_backlog_items": 144, "has_active_blockers": false, "next_backlog_item": null, "open_backlog_items": 0, "priority_backlog_groups": {"P0": {"completed": 4, "next_item": null, "open": 0}, "P1": {"completed": 80, "next_item": null, "open": 0}, "P2": {"completed": 60, "next_item": null, "open": 0}}, "project_name": "R"}
```
